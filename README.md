# SkySchool on DRF (проект платформы для онлайн-обучения)
...
1. **materials** содержит модули для функционирования приложения lms, директорию с миграциями
...
```
git clone https://github.com/AelitaDi/SkySchool
cd SkySchool
```
